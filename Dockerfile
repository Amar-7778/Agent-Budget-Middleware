...
# Entrypoint: Run Uvicorn with 4 workers and 30s graceful shutdown timeout
CMD ["sh", "-c", "uvicorn app.main:app --host 0.0.0.0 --port ${APP_PORT:-8000} --workers 4 --timeout-graceful-shutdown 30"]
